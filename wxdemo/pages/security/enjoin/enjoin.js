...
Page({
  ...
  tj: function (e) {
    if (e.detail.value.content == '' || e.detail.value.people == '') {
        ...
        wx.request({
          ...
          success(res) {
            ...
            if (style == 0) {
              ...
              wx.request({
                url: 'https://www.jinlingjiankang.com/nursingms/wechat/tempadvice/add',
                data: {
                  "userID": userid,
                  "oldId": oldID,
              ...
              wx.request({
                url: 'https://www.jinlingjiankang.com/nursingms/wechat/longtermadvice/add',
                data: {
                  "userID": userid,
                  "oldId": oldID,
                  "content": e.detail.value.content,
